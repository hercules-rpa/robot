...
class GlobalSettings():
    def __init__(self, edma_host_sparql,edma_host_servicios,edma_port_sparql,sgi_user,sgi_password,sgi_ip,sgi_port,datbase_ip,database_port,ftp_user,ftp_password):
