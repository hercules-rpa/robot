...
class TestExtractProjectsAndContracts(unittest.TestCase):
    ...
    def test_extract_projects_contracts_errors(self):
        ...
        self.assertEqual(msg,'Título: pueba<br>Fecha inicio: 15/03/2022<br>Fecha fin: 31/03/2022<br>Investigadores: JUANA MENCHON MARTINEZ, REYES HERNANDEZ-MORA MARTINEZ<br>Url: <a href="https://sgi.demo.treelogic.com/csp/proyectos/140016/ficha-general" target="_blank">elemento-140016/ficha-general</a><br>')
